...
class MixcloudListAdapter: ListAdapter<MixcloudShow, MixcloudListAdapter.MixcloudShowViewHolder>(MixcloudShowDiffUtil()) {
    ...
    inner class MixcloudShowViewHolder(private val binding: ItemCarouselImageCardBinding) :
        RecyclerView.ViewHolder(binding.root) {
            fun bind(item: MixcloudShow) {
                binding.coverImage.loadImage(item.imageUrlMedium)
